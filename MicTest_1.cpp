/// https://www.instructables.com/EasyFFT-Frequency-Transform-for-Arduino/
...
//---> here onward out_r contains amplitude and our_in conntains frequency (Hz)
    ...
    for(int i=0;i<data[o-1];i++)               // getting amplitude from compex number
        {
         out_r[i]=(out_r[i]*out_r[i]+out_im[i]*out_im[i]); // to  increase the speed delete sqrt
